...
# File: re04.py
# Description - Search the text file mbox-short.txt for lines that start with From and have an at sign
...
for line in hand:
    ...
    line = line.rstrip()
    # The ^From:.+@ character anchors the match to the beginning of the line.
    # Check if the line starts with From: ,
    # followed by one or more characters .+ , and then an @ symbol.
